 ...
 glGetIntegerv(GL_VIEWPORT, viewport);
  ...
  FILE *fScreenshot;
    ...
    if ( ((nw>=0) && (w!=nw)) || ((nh>=0) && (h!=nh)))
    {
      ...
      int nSize2 = nw*nh* 3;
      GLubyte *pixels2 = new GLubyte [nSize2];
      gluScaleImage(GL_RGB,w,h,GL_UNSIGNED_BYTE,pixels,nw,nh,GL_UNSIGNED_BYTE,pixels2);
      delete pixels;
      pixels = pixels2;
      w=nw; h=nh;
      nSize=nSize2;
