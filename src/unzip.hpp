...
// Chriddo made some further changes for the inclusion into Cubosphere



DECLARE_HANDLE(HZIP);
//typedef unsigned long int HZIP;
...
unsigned long GetCurrentCentralDirIndex(HZIP hz,unsigned long *cdi);
